    ...
    public static void main(String[] args) throws Exception {
        ...
        BoundedOutOfOrdernessTimestampExtractor<String> assigner = new BoundedOutOfOrdernessTimestampExtractor<String>(Time.milliseconds(MAX_EVENT_DELAY)) {
            ...
            public long extractTimestamp(String element) {
                ...
                try {
                    visitEvent = JSON.parseObject(element,VisitEvent.class);
        ...
        SingleOutputStreamOperator<UrlVisitBy> uvCounter = dataStreamByEventTime
                .map(str-> JSON.parseObject(str,VisitEvent.class))
                .map(visitEvent-> new Tuple3<String, VisitEvent, String>(visitEvent.getVisitUrl(), visitEvent,visitEvent.getVisitUserId()))
