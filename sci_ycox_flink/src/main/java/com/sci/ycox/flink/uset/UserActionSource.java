...
public class UserActionSource implements StreamTableSource<Row>, DefinedRowtimeAttributes {
    ...
    public DataStream<Row> getDataStream(StreamExecutionEnvironment see) {
        return stream.map(json -> {
            SourceEntity source = JSONObject.parseObject(json, SourceEntity.class);
    ...
    public List<RowtimeAttributeDescriptor> getRowtimeAttributeDescriptors() {
        ...
        List<RowtimeAttributeDescriptor> listRows = Collections.singletonList(rowtimeAttrDescr);
        return listRows;
    }
}
